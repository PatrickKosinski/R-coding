setwd("C:/Users/Patrick/Documents/Eigene Dokumente/Dokumente/Persoenliches/Lebenslauf/Coursera/01_R_Foundations/02_Codes/Capstone/Katz Back Off Word Prediction")
...
exploratory_analysis <- function(name, p){
        # upload the data
        directory <- paste0("C:/Users/Patrick/Documents/Eigene Dokumente/Dokumente/Persoenliches/Lebenslauf/Coursera/01_R_Foundations/02_Codes/Capstone/Katz Back Off Word Prediction/data/dataset/final/en_US/", name)
